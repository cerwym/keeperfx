...
const struct NamedField trapdoor_door_named_fields[] = {
    ...
    {"NAME",                 0, field(gpGame->conf.trapdoor_conf.door_cfgstats[0], code_name),                0,   INT32_MIN,         UINT32_MAX, door_desc,                value_name,       assign_null},
    {"NAMETEXTID",           0, field(gpGame->conf.trapdoor_conf.door_cfgstats[0], name_stridx),   GUIStr_Empty,   INT32_MIN,         UINT32_MAX, NULL,                     value_default,    assign_default},
    {"TOOLTIPTEXTID",        0, field(gpGame->conf.trapdoor_conf.door_cfgstats[0], tooltip_stridx),GUIStr_Empty,   INT32_MIN,         UINT32_MAX, NULL,                     value_default,    assign_tooltip_idx_door},
    {"SYMBOLSPRITES",        0, field(gpGame->conf.trapdoor_conf.door_cfgstats[0], bigsym_sprite_idx),        0,   INT32_MIN,         UINT32_MAX, NULL,                     value_icon,       assign_icon},
    {"SYMBOLSPRITES",        1, field(gpGame->conf.trapdoor_conf.door_cfgstats[0], medsym_sprite_idx),        0,   INT32_MIN,         UINT32_MAX, NULL,                     value_icon,       assign_icon_update_trap_tab},
    {"POINTERSPRITES",       0, field(gpGame->conf.trapdoor_conf.door_cfgstats[0], pointer_sprite_idx),       0,   INT32_MIN,         UINT32_MAX, NULL,                     value_icon,       assign_icon_update_trap_tab},
    {"PANELTABINDEX",        0, field(gpGame->conf.trapdoor_conf.door_cfgstats[0], panel_tab_idx),            0,          0,                32, NULL,                     value_default,    assign_panel_tab_idx_door},
    {"CRATE",                0, NULL,0,                                                                   0,   INT32_MIN,         UINT32_MAX, object_desc,              value_default,    assign_crate_door},
    {"MANUFACTURELEVEL",     0, field(gpGame->conf.trapdoor_conf.door_cfgstats[0], manufct_level),            0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default,    assign_default},
    {"MANUFACTUREREQUIRED",  0, field(gpGame->conf.trapdoor_conf.door_cfgstats[0], manufct_required),         0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default,    assign_default},
    {"HEALTH",               0, field(gpGame->conf.trapdoor_conf.door_cfgstats[0], health),                   1,   INT32_MIN,         UINT32_MAX, NULL,                     value_default,    assign_update_door_stats},
    {"SLABKIND",             0, field(gpGame->conf.trapdoor_conf.door_cfgstats[0], slbkind[1]),               0,          0, TERRAIN_ITEMS_MAX, slab_desc,                value_default,    assign_default},
    {"SLABKIND",             0, field(gpGame->conf.trapdoor_conf.door_cfgstats[0], slbkind[0]),               0,          0, TERRAIN_ITEMS_MAX, slab_desc,                value_default,    assign_update_door_stats},
    {"OPENSPEED",            0, field(gpGame->conf.trapdoor_conf.door_cfgstats[0], open_speed),             256,   INT32_MIN,         UINT32_MAX, NULL,                     value_default,    assign_default},
    {"PROPERTIES",          -1, field(gpGame->conf.trapdoor_conf.door_cfgstats[0], model_flags),              0,   INT32_MIN,         UINT32_MAX, door_properties_commands, value_flagsfield, assign_default},
    {"SELLINGVALUE",         0, field(gpGame->conf.trapdoor_conf.door_cfgstats[0], selling_value),            0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default,    assign_default},
    {"UNSELLABLE",           0, field(gpGame->conf.trapdoor_conf.door_cfgstats[0], unsellable),               0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default,    assign_default},
    {"PLACESOUND",           0, field(gpGame->conf.trapdoor_conf.door_cfgstats[0], place_sound_idx),        117,   INT32_MIN,         UINT32_MAX, NULL,                     value_default,    assign_default},
    {"UPDATEFUNCTION",       0, field(gpGame->conf.trapdoor_conf.door_cfgstats[0], updatefn_idx),             0,   INT32_MIN,         UINT32_MAX, NULL,                     value_function,   assign_default},
    {NULL},
};
...
const struct NamedField trapdoor_trap_named_fields[] = {
    //name           //pos    //field                                                                //default //min     //max    //NamedCommand
    {"NAME",                   0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], code_name),                        0,   INT32_MIN,         UINT32_MAX, door_desc,                value_name,    assign_null},
    {"MANUFACTURELEVEL",       0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], manufct_level),                    0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"MANUFACTUREREQUIRED",    0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], manufct_required),                 0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"SHOTS",                  0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], shots),                            0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"TIMEBETWEENSHOTS",       0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], shots_delay),                      0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"SELLINGVALUE",           0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], selling_value),                    0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"NAMETEXTID",             0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], name_stridx),                      0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"TOOLTIPTEXTID",          0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], tooltip_stridx),                   0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_tooltip_idx_trap},
    {"CRATE",                  0, NULL,0,                                                                           0,   INT32_MIN,         UINT32_MAX, object_desc,              value_default, assign_crate_trap},
    {"SYMBOLSPRITES",          0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], bigsym_sprite_idx),                0,   INT32_MIN,         UINT32_MAX, NULL,                        value_icon, assign_icon},
    {"SYMBOLSPRITES",          1, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], medsym_sprite_idx),                0,   INT32_MIN,         UINT32_MAX, NULL,                        value_icon, assign_icon_update_trap_tab},
    {"POINTERSPRITES",         0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], pointer_sprite_idx),               0,   INT32_MIN,         UINT32_MAX, NULL,                        value_icon, assign_icon_update_trap_tab},
    {"PANELTABINDEX",          0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], panel_tab_idx),                    0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_panel_tab_idx_trap},
    {"TRIGGERTYPE",            0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], trigger_type),                     0,   INT32_MIN,         UINT32_MAX, trap_trigger_type_commands,value_default, assign_default},
    {"ACTIVATIONTYPE",         0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], activation_type),                  0,   INT32_MIN,         UINT32_MAX, trap_activation_type_commands,value_default, assign_default},
    {"EFFECTTYPE",             0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], created_itm_model),                0,   INT32_MIN,         UINT32_MAX, NULL,            value_activationeffect, assign_default},
    {"ACTIVATIONLEVEL",        0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], activation_level),                 0,          0,                 9, NULL,                        value_min1, assign_default},
    {"ANIMATIONID",            0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], sprite_anim_idx),                  0,   INT32_MIN,         UINT32_MAX, NULL,                      value_animid, assign_refresh_trap_anim_anim_id},
    {"MODEL",                  0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], sprite_anim_idx),                  0,   INT32_MIN,         UINT32_MAX, NULL,                      value_animid, assign_refresh_trap_anim_anim_id}, // Backward compatibility.
    {"RECHARGEANIMATIONID",    0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], recharge_sprite_anim_idx),         0,   INT32_MIN,         UINT32_MAX, NULL,                      value_animid, assign_refresh_trap_anim_anim_id},
    {"ATTACKANIMATIONID",      0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], attack_sprite_anim_idx),           0,   INT32_MIN,         UINT32_MAX, NULL,                      value_animid, assign_animid},
    {"MODELSIZE",              0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], sprite_size_max),                  0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_refresh_trap_anim},
    {"ANIMATIONSPEED",         0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], anim_speed),                       0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_multiple_refresh_trap_anim},
    {"ATTACKANIMATIONSPEED",   0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], attack_anim_speed),                0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_refresh_trap_anim},
    {"RECHARGEANIMATIONSPEED", 0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], recharge_anim_speed),              0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_refresh_trap_anim},
    {"UNANIMATED",             0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], unanimated),                       0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_refresh_trap_anim},
    {"HIDDEN",                 0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], hidden),                        true,          0,                 1, NULL,                     value_default, assign_default},
    {"SLAPPABLE",              0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], slappable),                        0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"TRIGGERALARM",           0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], notify),                           0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"HEALTH",                 0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], health),                           1,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"UNSHADED",               0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], unshaded),                         0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"RANDOMSTARTFRAME",       0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], random_start_frame),               0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"THINGSIZE",              0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], size_xy),                          0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"THINGSIZE",              1, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], size_z),                           0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"HITTYPE",                0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], hit_type),                         0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"LIGHTRADIUS",            0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], light_radius),                     0,   INT32_MIN,         UINT32_MAX, NULL,                  value_stltocoord, assign_default},
    {"LIGHTINTENSITY",         0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], light_intensity),                  0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"LIGHTFLAGS",             0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], light_flag),                       0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"TRANSPARENCYFLAGS",      0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], transparency_flag),                0,   INT32_MIN,         UINT32_MAX, NULL,                   value_transpflg, assign_default},
    {"SHOTVECTOR",             0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], shotvector.x),                     0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"SHOTVECTOR",             1, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], shotvector.y),                     0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"SHOTVECTOR",             2, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], shotvector.z),                     0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"DESTRUCTIBLE",           0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], destructible),                     0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"UNSTABLE",               0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], unstable),                         0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"UNSELLABLE",             0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], unsellable),                       0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"PLACEONBRIDGE",          0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], place_on_bridge),                  0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"SHOTORIGIN",             0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], shot_shift_x),                     0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"SHOTORIGIN",             1, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], shot_shift_y),                     0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"SHOTORIGIN",             2, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], shot_shift_z),                     0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"PLACESOUND",             0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], place_sound_idx),                117,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"TRIGGERSOUND",           0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], trigger_sound_idx),              176,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"DESTROYEDEFFECT",        0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], destroyed_effect), -TngEffElm_Blast2,   INT32_MIN,         UINT32_MAX, NULL,                  value_effOrEffEl, assign_default},
    {"INITIALDELAY",           0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], initial_delay),                    0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"PLACEONSUBTILE",         0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], place_on_subtile),                 0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"FLAMEANIMATIONID",       0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], flame.animation_id),               0,   INT32_MIN,         UINT32_MAX, NULL,                      value_animid, assign_refresh_trap_anim_anim_id},
    {"FLAMEANIMATIONSPEED",    0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], flame.anim_speed),                 0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"FLAMEANIMATIONSIZE",     0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], flame.sprite_size),                0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"FLAMEANIMATIONOFFSET",   0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], flame.fp_add_x),                   0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"FLAMEANIMATIONOFFSET",   1, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], flame.fp_add_y),                   0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"FLAMEANIMATIONOFFSET",   2, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], flame.td_add_x),                   0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"FLAMEANIMATIONOFFSET",   3, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], flame.td_add_y),                   0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"FLAMETRANSPARENCYFLAGS", 0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], flame.transparency_flags),         0,   INT32_MIN,         UINT32_MAX, NULL,                   value_transpflg, assign_default},
    {"DETECTINVISIBLE",        0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], detect_invisible),              true,          0,                 1, NULL,                     value_default, assign_default},
    {"INSTANTPLACEMENT",       0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], instant_placement),                0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"REMOVEONCEDEPLETED",     0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], remove_once_depleted),             0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"FLAGNUMBER",             0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], flag_number),                      0,   INT32_MIN,         UINT32_MAX, NULL,                     value_default, assign_default},
    {"UPDATEFUNCTION",         0, field(gpGame->conf.trapdoor_conf.trap_cfgstats[0], updatefn_idx),                     0,   INT32_MIN,         UINT32_MAX, NULL,                     value_function,assign_default},
    {NULL},
};
#pragma pop_macro("game")
