...
enum GUIStrings {
    ...
    GUIStr_MnuFreePlayLevels = STRINGS_MAX+943,
    GUIStr_MnuLandSelection = STRINGS_MAX+944,
    GUIStr_MnuCampaigns = STRINGS_MAX+945,
    GUIStr_MnuAddComputer = STRINGS_MAX+946,
