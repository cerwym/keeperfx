...
const struct NamedField magic_shot_named_fields[] = {
  {"NAME",                  0, field_t(struct ShotConfigStats, code_name),                   0,  INT32_MIN,  UINT32_MAX, shot_desc,                    value_name,      assign_null},
  {"HEALTH",                0, field_t(struct ShotConfigStats, health),                      0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"DAMAGE",                0, field_t(struct ShotConfigStats, damage),                      0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"ISMAGICAL",             0, field_t(struct ShotConfigStats, is_magical),                  0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"HITTYPE",               0, field_t(struct ShotConfigStats, area_hit_type),  THit_CrtrsOnly,  INT32_MIN,  UINT32_MAX, hit_type_desc,                value_default,   assign_default},
  {"AREADAMAGE",            0, field_t(struct ShotConfigStats, area_range),                  0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"AREADAMAGE",            1, field_t(struct ShotConfigStats, area_damage),                 0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"AREADAMAGE",            2, field_t(struct ShotConfigStats, area_blow),                   0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  ...
  {"ANIMATIONSIZE",         0, field_t(struct ShotConfigStats, sprite_size_max),             0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"SPELLEFFECT",           0, field_t(struct ShotConfigStats, cast_spell_kind),            0,  INT32_MIN,  UINT32_MAX, spell_desc,                   value_default,   assign_default},
  {"BOUNCEANGLE",           0, field_t(struct ShotConfigStats, bounce_angle),                0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"SIZE_XY",               0, field_t(struct ShotConfigStats, size_xy),                     0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"SIZE_YZ",               0, field_t(struct ShotConfigStats, size_z),                      0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"SIZE_Z",                0, field_t(struct ShotConfigStats, size_z),                      0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"FALLACCELERATION",      0, field_t(struct ShotConfigStats, fall_acceleration),           0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"VISUALEFFECT",          0, field_t(struct ShotConfigStats, visual.effect_model),         0,  INT32_MIN,  UINT32_MAX, NULL,                         value_effOrEffEl,   assign_default},
  {"VISUALEFFECTAMOUNT",    0, field_t(struct ShotConfigStats, visual.amount),               0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  ...
  {"EXPLOSIONEFFECTS",      2, field_t(struct ShotConfigStats, explode.around_effect1_model),0,  INT32_MIN,  UINT32_MAX, NULL,                         value_effOrEffEl,   assign_default},
  {"EXPLOSIONEFFECTS",      3, field_t(struct ShotConfigStats, explode.around_effect2_model),0,  INT32_MIN,  UINT32_MAX, NULL,                         value_effOrEffEl,   assign_default},
  {"WITHSTANDHITAGAINST",  -1, NULL,0,                                                                   0,  INT32_MIN,  INT32_MAX,  shotmodel_withstand_types,    value_flagsfield,   assign_withstand},
  {"ANIMATIONTRANSPARENCY", 0, field_t(struct ShotConfigStats, animation_transparency),      0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"DESTROYONHIT",          0, field_t(struct ShotConfigStats, destroy_on_first_hit),        0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"BASEEXPERIENCEGAIN",    0, field_t(struct ShotConfigStats, experience_given_to_shooter), 0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"TARGETHITSTOPTURNS",    0, field_t(struct ShotConfigStats, target_hitstop_turns),        0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"SHOTSOUNDPRIORITY",     0, field_t(struct ShotConfigStats, sound_priority),              0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"LIGHTING",              0, field_t(struct ShotConfigStats, light_radius),                0,  INT32_MIN,  UINT32_MAX, NULL,                         value_stltocoord,   assign_default},
  {"LIGHTING",              1, field_t(struct ShotConfigStats, light_intensity),             0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"LIGHTING",              2, field_t(struct ShotConfigStats, light_flags),                 0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"INERTIA",               0, field_t(struct ShotConfigStats, inertia_floor),               0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"INERTIA",               1, field_t(struct ShotConfigStats, inertia_air),                 0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"UNSHADED",              0, field_t(struct ShotConfigStats, unshaded),                    0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"SOFTLANDING",           0, field_t(struct ShotConfigStats, soft_landing),                0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"EFFECTMODEL",           0, field_t(struct ShotConfigStats, effect_id),                   0,  INT32_MIN,  UINT32_MAX, NULL,                         value_effOrEffEl,   assign_default},
  {"FIRELOGIC",             0, field_t(struct ShotConfigStats, fire_logic),                  0,  INT32_MIN,  UINT32_MAX, shotfirelogic_commands,       value_default,   assign_default},
  {"UPDATELOGIC",           0, field_t(struct ShotConfigStats, update_logic),                0,  INT32_MIN,  UINT32_MAX, shotupdatelogic_commands,     value_function,   assign_default},
  ...
  {"PERIODICAL",            0, field_t(struct ShotConfigStats, periodical),                  0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"SPEEDDEVIATION",        0, field_t(struct ShotConfigStats, speed_deviation),             0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"SPREAD_XY",             0, field_t(struct ShotConfigStats, spread_xy),                   0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"SPREAD_Z",              0, field_t(struct ShotConfigStats, spread_z),                    0,  INT32_MIN,  UINT32_MAX, NULL,                         value_default,   assign_default},
  {"HITTHINGFUNC",          0, field_t(struct ShotConfigStats, hit_thing_lua_func_idx),      0,  INT32_MIN,  UINT32_MAX, NULL,                         value_function,   assign_default},
  {NULL},
  };

static int32_t* get_shot_types_count(void) { return &game.conf.magic_conf.shot_types_count; }
static void* get_shot_cfgstats_base(void) { return game.conf.magic_conf.shot_cfgstats; }

const struct NamedFieldSet magic_shot_named_fields_set = {
    get_shot_types_count,
    "shot",
    magic_shot_named_fields,
    shot_desc,
    MAGIC_ITEMS_MAX,
    sizeof(game.conf.magic_conf.shot_cfgstats[0]),
    get_shot_cfgstats_base,
};
