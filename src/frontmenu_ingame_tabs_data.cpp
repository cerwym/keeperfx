...
struct GuiButtonInit main_menu_buttons[] = {
  {LbBtnT_NormalBtn,    BID_OPTIONS,-2, 0,                 NULL,           NULL,  NULL,               0,  68,   0,  68,   0, 68, 16, gui_area_new_normal_button, GPS_rpanel_rpanel_btn_quit_act, GUIStr_MnuOptionsDesc,&options_menu, {0},        0, NULL },
  {LbBtnT_NormalBtn,BID_MAP_ZOOM_IN,-2, 0,          gui_zoom_in,           NULL,  NULL,               0, 112,   4, 114,   4, 26, 66, gui_area_new_vertical_button, GPS_rpanel_rpanel_mapbt2a, GUIStr_PaneZoomInDesc,      0,       {0},            0, NULL },
  {LbBtnT_NormalBtn,BID_MAP_ZOOM_OU,-2, 0,         gui_zoom_out,           NULL,  NULL,               0, 110,  70, 114,  70, 26, 66, gui_area_new_vertical_button, GPS_rpanel_rpanel_mapbt3a, GUIStr_PaneZoomOutDesc,     0,       {0},            0, NULL },
  {LbBtnT_NormalBtn,BID_MAP_ZOOM_FS,-2, 0,        gui_go_to_map,           NULL,  NULL,               0,   0,   0,   0,   0, 30, 31, gui_area_new_vertical_button, GPS_rpanel_rpanel_btn_bigmap_act, GUIStr_PaneLargeMapDesc,    0,       {0},            0, NULL },
  {LbBtnT_NormalBtn,    BID_DEFAULT,-2, 0,gui_turn_on_autopilot,           NULL,  NULL,               0,   0,  70,   0,  70, 16, 67, gui_area_autopilot_button, GPS_rpanel_rpanel_btn_cassisti_act, GUIStr_Empty,               0,       {0},            0, maintain_turn_on_autopilot },
...
struct GuiButtonInit creature_menu_buttons[] = {
  ...
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, pick_up_next_creature,gui_go_to_next_creature,gui_over_creature_button,  0,   0, 196,   0, 218, 22, 22, gui_area_creature_list_icon,            0, GUIStr_PickCreatrMostExpDesc,  0,       {0},            0, maintain_activity_pic },
  ...
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, pick_up_next_creature,gui_go_to_next_creature,gui_over_creature_button,  1,   0, 220,   0, 242, 22, 22, gui_area_creature_list_icon,            0, GUIStr_PickCreatrMostExpDesc,  0,       {0},            0, maintain_activity_pic },
  ...
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, pick_up_next_creature,gui_go_to_next_creature,gui_over_creature_button,  2,   0, 244,   0, 266, 22, 22, gui_area_creature_list_icon,            0, GUIStr_PickCreatrMostExpDesc,  0,       {0},            0, maintain_activity_pic },
  ...
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, pick_up_next_creature,gui_go_to_next_creature,gui_over_creature_button,  3,   0, 268,   0, 290, 22, 22, gui_area_creature_list_icon,            0, GUIStr_PickCreatrMostExpDesc,  0,       {0},            0, maintain_activity_pic },
  ...
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, pick_up_next_creature,gui_go_to_next_creature,gui_over_creature_button,  4,   0, 292,   0, 314, 22, 22, gui_area_creature_list_icon,            0, GUIStr_PickCreatrMostExpDesc,  0,       {0},            0, maintain_activity_pic },
  ...
  {LbBtnT_NormalBtn,    BID_DEFAULT, 0, 0, pick_up_next_creature,gui_go_to_next_creature,gui_over_creature_button,  5,   0, 314,   0, 338, 22, 22, gui_area_creature_list_icon,            0, GUIStr_PickCreatrMostExpDesc,  0,       {0},            0, maintain_activity_pic },
...
struct GuiMenu creature_query_menu1 =
 {GMnu_CREATURE_QUERY1, 0, 1, creature_query_buttons1,              0,   0, 140, 400, gui_creature_portrait_large,0,NULL,   NULL,                    0, 0, 1,};
struct GuiMenu creature_query_menu2 =
 {GMnu_CREATURE_QUERY2, 0, 1, creature_query_buttons2,              0,   0, 140, 400, gui_creature_portrait_large,0,NULL,   NULL,                    0, 0, 1,};
struct GuiMenu creature_query_menu3 =
 {GMnu_CREATURE_QUERY3, 0, 1, creature_query_buttons3,              0,   0, 140, 400, gui_creature_query_icon,0,NULL,   NULL,                    0, 0, 1,};
struct GuiMenu creature_query_menu4 =
 {GMnu_CREATURE_QUERY4, 0, 1, creature_query_buttons4,              0,   0, 140, 400, gui_creature_query_icon,0,NULL,   NULL,                    0, 0, 1,};
