...
const struct NamedField crstates_states_named_fields[] = {
    {"NAME",                   0, field(gpGame->conf.crtr_conf.states[0], name),                        0,        0,      0,              creatrstate_desc,  value_name,      assign_null},
    {"PROCESSFUNCTION",        0, field(gpGame->conf.crtr_conf.states[0], process_state),               0,        0,      0,         process_func_commands,  value_function,  assign_default},
    {"CLEANUPFUNCTION",        0, field(gpGame->conf.crtr_conf.states[0], cleanup_state),               0,        0,      0,         cleanup_func_commands,  value_function,  assign_default},
    {"MOVEFROMSLABFUNCTION",   0, field(gpGame->conf.crtr_conf.states[0], move_from_slab),              0,        0,      0,  move_from_slab_func_commands,  value_function,  assign_default},
    {"MOVECHECKFUNCTION",      0, field(gpGame->conf.crtr_conf.states[0], move_check),                  0,        0,      0,      move_check_func_commands,  value_function,  assign_default},
    {"OVERRIDES",             -1, NULL,0,                                                           0,        0,      0,                          NULL,  value_overrides, assign_null},
    {"STATETYPE",              0, field(gpGame->conf.crtr_conf.states[0], state_type),                  0,        0,      0, creature_state_types_commands,  value_default,   assign_default},
    {"CAPTIVE",                0, field(gpGame->conf.crtr_conf.states[0], captive),                     0,        0,      1,                          NULL,  value_default,   assign_default},
    {"TRANSITION",             0, field(gpGame->conf.crtr_conf.states[0], transition),                  0,        0,      1,                          NULL,  value_default,   assign_default},
    {"FOLLOWBEHAVIOR",         0, field(gpGame->conf.crtr_conf.states[0], follow_behavior),             0,        0,      0,      follow_behavior_commands,  value_default,   assign_default},
    {"BLOCKSALLSTATECHANGES",  0, field(gpGame->conf.crtr_conf.states[0], blocks_all_state_changes),    0,        0,      1,                          NULL,  value_default,   assign_default},
    {"SPRITEIDX",              0, field(gpGame->conf.crtr_conf.states[0], sprite_idx),                  0,        0,      0,                          NULL,  value_icon,      assign_icon},
    {"DISPLAYTHOUGHTBUBBLE",   0, field(gpGame->conf.crtr_conf.states[0], display_thought_bubble),      0,        0,      1,                          NULL,  value_default,   assign_default},
    {"SNEAKY",                 0, field(gpGame->conf.crtr_conf.states[0], sneaky),                      0,        0,      1,                          NULL,  value_default,   assign_default},
    {"REACTTOCTA",             0, field(gpGame->conf.crtr_conf.states[0], react_to_cta),                0,        0,      1,                          NULL,  value_default,   assign_default},
    {NULL},
};
