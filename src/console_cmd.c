...
static const struct ConsoleCommand console_commands[] = {
    ...
    { "wireframe", cmd_wireframe, NULL },
    { "renderer.fullbright", cmd_renderer_fullbright, NULL },
    { "renderer.ambient", cmd_renderer_ambient, NULL },
    { "renderer.shade_scale", cmd_renderer_shade_scale, NULL },
    { "renderer.shade_gamma", cmd_renderer_shade_gamma, NULL },
    { "renderer.palette_mode", cmd_renderer_palette_mode, NULL },
    { "renderer.tile_filter", cmd_renderer_tile_filter, NULL },
    { "renderer.darkness_mode", cmd_renderer_darkness_mode, NULL },
    { "renderer.fog_speed", cmd_renderer_fog_speed, NULL },
    { "renderer.fog_density", cmd_renderer_fog_density, NULL },
    { "renderer.zoom_box_mode", cmd_renderer_zoom_box_mode, NULL },
