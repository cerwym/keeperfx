...
.DESCRIPTION
    Reads packaging/assets.json for canonical sources (dkfans repos, pinned tags).
    If packaging/assets.local.json exists, its entries override the canonical ones —
...
.EXAMPLE
    .\packaging\fetch-assets.ps1
    .\packaging\fetch-assets.ps1 -Force
#>
param(
    [switch]$Force
)
