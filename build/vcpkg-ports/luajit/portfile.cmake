...
if(VCPKG_DETECTED_MSVC)
    ...
    if("buildvm-32" IN_LIST FEATURES)
        # On arm/arm32 native hosts, build both arm and x86 host tools.
        # On x64 hosts (cross-compiling to x86), only build x86:
        # LuaJIT src/Makefile gives "Unsupported target architecture" for ARM
        # when the host is x64, so we skip the arm buildvm entirely.
        if(VCPKG_HOST_IS_ARM64 OR (VCPKG_HOST_ARCHITECTURE STREQUAL "arm"))
            string(APPEND dasm_archs " arm x86")
        else()
            string(APPEND dasm_archs " x86")
        endif()
    endif()
