...
if(NOT PLATFORM_VITA AND NOT PLATFORM_3DS AND NOT PLATFORM_SWITCH)
    ...
    if(KEEPERFX_RENDERER_VULKAN)
        ...
        if(Vulkan_FOUND AND vk-bootstrap_FOUND)
            ...
            target_link_libraries(keeperfx_hvlog PUBLIC Vulkan::Vulkan vk-bootstrap::vk-bootstrap)
            if(VulkanMemoryAllocator_FOUND)
                target_link_libraries(keeperfx    PUBLIC GPUOpen::VulkanMemoryAllocator)
                target_link_libraries(keeperfx_hvlog PUBLIC GPUOpen::VulkanMemoryAllocator)
    ...
    if(KEEPERFX_MATCHMAKING)
        ...
        elseif(WIN32)
            # MinGW: look in cross-compile sysroot (populated by CI inline install step)
            find_library(CURL_LIB NAMES curl libcurl PATHS ${CMAKE_FIND_ROOT_PATH}/lib NO_DEFAULT_PATH)
            find_path(CURL_INCLUDE NAMES curl/curl.h PATHS ${CMAKE_FIND_ROOT_PATH}/include NO_DEFAULT_PATH)
        ...
        if(CURL_FOUND OR (WIN32 AND CURL_LIB AND CURL_INCLUDE))
