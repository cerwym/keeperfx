...
#
# Usage:
#   bash tools/init-deploy.sh --dk-path "/games/DungeonKeeper"
#   bash tools/init-deploy.sh --use-alpha
#   bash tools/init-deploy.sh --kfx-version 1.3.2
#   bash tools/init-deploy.sh --refresh-runtime-layer
#
# Options:
...
DK_DOCKERFILE="$WS/docker/dk-originals/Dockerfile"
RUNTIME_DOCKERFILE="$WS/docker/kfx-runtime-assets/Dockerfile"
...
build_runtime_assets_in_docker() {
    echo "Generating pkg runtime assets in docker/linux ..."
